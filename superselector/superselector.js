...
//	Add load event listener
	window.addEventListener("load", this.initialize(this), false);
};
...
superselector.prototype.highlight = function(target)
{
	...
	{
		this.prevElement.style.border = this.prevElementBorder;
	}
	this.prevElement = target;
	this.prevElementBorder = target.style.border;
	target.style.border = "2px black dashed";
}
